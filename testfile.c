...
Struct add (int *RegisterArray, int bit_pattern) { 
    ...
    uint16_t sum = RegisterArray[t] + RegisterArray[s]; 
...
Struct divide (int *RegisterArray, int *HILORegisterArray, int bit_pattern) {
    ...
    int32_t HI = RegisterArray[s] % RegisterArray[t]; 
    int32_t LO = RegisterArray[s] / RegisterArray[t]; 
...
Struct mul (int *RegisterArray, int bit_pattern) { 
    ...
    uint16_t mul = RegisterArray[t] * RegisterArray[s]; 
...
Struct syscall (int *RegisterArray, int RegisterN) {
    ...
    if (RegisterN != 2) {
        printf("Wrong register input into function\n"); 
        exit(0); 
    }
